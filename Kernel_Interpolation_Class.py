...
class Kernel_Interpolation_GPR_based(GaussianProcessRegressor):
    def __init__(self, kernel):
        super().__init__(kernel, alpha=0, optimizer=None, n_restarts_optimizer=0,
    ...
    def fit(self, X, y):
        ...
        Returns:
            coeffs (array): coefficients of RKHS function
        """
    ...
    def power_function(self):
        ...
        def power_function_inner(X_train, X_test):
            ...
            Args:
                ...
                X_test (array): samples where to evaluate power function
            Return:
    ...
    def predict(self, X_train, coeffs):
        ...
        """
        return lambda X: self.kernel(X.reshape(1, X_train.shape[1]),
                                     X_train) @ coeffs  # TODO: do not hard-code dimensions, it should work for all!
